...
const SpecificItem = () => {
	return (
		<PhotoAndVideoSection
			...
			date={"July 2025"}
			description={
				"Aerial photography of the stunning landscapes of Dinara in Croatia, capturing the rugged mountain terrain and lush greenery."
			}
			...
			additionalInfo={
				"Experience the breathtaking aerial views of Dinara, Croatia, showcasing the rugged mountain terrain and lush landscapes. Captured in July 2025, these images highlight the natural beauty and diverse geography of the region."
			}
		/>
	);
};
