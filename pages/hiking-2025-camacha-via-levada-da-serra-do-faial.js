...
const PHOTOS = [
  "./static/img/hiking/2025/camacha-via-levada-da-serra-do-faial/camacha_01.jpg",
  "./static/img/hiking/2025/camacha-via-levada-da-serra-do-faial/camacha_02.jpg",
  "./static/img/hiking/2025/camacha-via-levada-da-serra-do-faial/camacha_03.jpg",
];
...
const SpecificItem = () => {
  return (
    <PhotoAndVideoSection
      ...
      id={"hiking-2025-camacha-via-levada-da-serra-do-faial"}
